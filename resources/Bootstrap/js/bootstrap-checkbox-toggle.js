...
+ function(a) {
  ...
  c.VERSION = "2.2.0", c.DEFAULTS = {
    ...
    this._onstyle = "btn-xs" + this.options.onstyle, this._offstyle = "btn-xs" + this.options.offstyle;
    var b = "large" === this.options.size ? "btn-lg" : "small" === this.options.size ? "btn-sm" : "mini" === this.options.size ? "btn-" : "",
